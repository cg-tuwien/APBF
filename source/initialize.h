...
namespace pbd
{
	...
	public:
		...
		static pbd::particles add_sphere_shape(pbd::particles& aParticles, const glm::vec3& aCenter, float aShapeRadius, float aParticleRadius = 1.0f, float aInverseDensity = 1.0f, const glm::vec3& aVelocity = glm::vec3(0));
