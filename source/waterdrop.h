...
{
public:
	waterdrop(const glm::vec3& aMin, const glm::vec3& aMax, const glm::vec3& aDropCenter, float aDropRadius, float aRadius = 1.0f);
	waterdrop(const glm::vec3& aMin, const glm::vec3& aMax, const glm::vec3& aDropCenter, float aDropRadius, gvk::camera& aCamera, float aRadius = 1.0f);
...
private:
	...
	pbd::particles mParticlesWithDrop;
	pbd::fluid mFluid;
